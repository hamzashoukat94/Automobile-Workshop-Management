...
import Calculation.*;
public class Mechanics extends ParentGui {
	...
	public void functioanlity()
	{
		Conn=DBconnect.dbConnector();
		jf=new JFrame("Mechanic Report");
		String[] selection={"Mechanic_id","F_name","L_name","Contact"};
	...
	tf1=new JTextField();
	 ...
	 table=new JTable();
		...
		jf.setContentPane(new JLabel(new ImageIcon("D:\\Academics\\4th Semister\\Object Oriented programming\\Lab Area\\Programs java\\Workshop\\images\\images.jpg")));
		c=jf.getContentPane();
...
b2.addActionListener(new  ActionListener(){
	...
	try{  
		...
		String ge=(String)select.getSelectedItem();
		String query="select * from Employees where "+ge+"=?";
