...
import Calculation.*;
public class SparePartsManage extends ParentGui {
...
public void functionality()
{
	...
	l2=new JLabel(new ImageIcon("D:\\Academics\\4th Semister\\\bject Oriented programming\\Lab Area\\Programs java\\Workshop\\images\\images.jpg"));
	l3=new JLabel("   Home");
	...
	Font fontSs=new Font("Serif",8,18);
